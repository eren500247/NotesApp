...
import AddNoteImg from "../../assets/add-note-img.png";
import NoNoteImg from "../../assets/no-note-img.png";
...
const Home = () => {
  ...
  const handleOpenDetailModal = ()=>{
    setOpenDetailModal({
      ...openDetailModal,
      isShown : !openDetailModal.isShown
    })
  }
  return (
    <>
      ...
      <button
        className="w-12 h-12 flex items-center justify-center rounded-2xl bg-primary hover:bg-blue-600 absolute right-10 bottom-10 cursor-pointer"
        onClick={() =>
      ...
      <Modal
        ...
        className="w-[40%] max-h-3/4 bg-white rounded-md mx-auto mt-24 p-5 overflow-scroll"
      >
        <DetailCard data={openDetailModal.data} onClose={() => handleOpenDetailModal()} />
      </Modal>
